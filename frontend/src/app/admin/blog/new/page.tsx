...
export default function NewBlogPostPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="font-mono text-star-gold text-xl font-bold mb-6">New Blog Post</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        <Field label="Slug *" hint="lowercase, hyphens only (e.g. my-first-post)">
        ...
        <Field label="Body (Markdown)">
          <textarea className={`${input} h-64 resize-y font-mono text-xs`} value={form.body} onChange={(e) => set("body", e.target.value)} placeholder="# Heading&#10;&#10;Write your post in Markdown..." />
        </Field>
        <Field label="Tags" hint="comma-separated">
          <input className={input} value={form.tags} onChange={(e) => set("tags", e.target.value)} placeholder="React, TypeScript, Web" />
        </Field>
